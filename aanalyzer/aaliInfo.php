<!DOCTYPE HTML>
<!--  -->
<html><!-- InstanceBegin template="/Templates/PlatillaAli.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
	<meta charset="UTF-8">
...
<body>
	<div id="header">
		<div>
			<div>
				<span> </span>
				<a href="aanaHome.htm" class="logo"><img src="images/aali/logo.png" alt="" width="200" height="100" border="0"></a>
				<span class="tagline"> </span>
			</div>
			<ul>

<!-- InstanceBeginEditable name="menup" -->			
				<li><a href="aaliHome.htm">home</a></li>	
				<li class="selected"><a href="aaliInfo.php">Contact Information </a></li>
	...
	<div id="body">
		...
		<div id="content">
			...
			<div id="sidebar">
				...
				<ul>
					<li class="selected collapse">
						<a href="">Home</a>
                        <ul>
                          <li> <a href="aaliHome.htm">AAligner</a></li>
                          <li class="selected"> <a href="aaliInfo.php">Contact information</a></li>
                        </ul>
					</li>
			...
			<div id="section">
	          ...
	          <p> <br>
                  <span class="article Estilo2">Pascual Orozco 909-18, Col. San Felipe </span></p>
...
<!-- InstanceEndEditable -->												
	<div id="footer">
		<div>
			...
			<ul>
				<li>
					<a href="aaliHome.htm">home</a>
				</li>
				<li>
				   <a href="aaliHome.htm"> AALIGNER</a>
				</li>
				<li>
					<a href="aaliInfo.php"> Contact Information</a>
				</li>
