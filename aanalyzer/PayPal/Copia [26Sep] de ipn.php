...
function enviaComprador($usernameDB,$passwordDB)
{	
		$from = "TechSupport Service <techsupport@rdataa.com>";
	    //$to = "Ventas <grivera@rdataa.com>";
	    $to = "ocastillo@qro.cinvestav.mx";
...
//*************enviaComprador($usernameDB,$passwordDB);
	...
	//escribeLog('ROW'.$row[0].$tx.' '.$payer_status.' '.$sql.chr(13).chr(10););
//************	enviaCorreoVentas();
