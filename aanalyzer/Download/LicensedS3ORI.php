...
//  $privatekey = "6LdFMwYTAAAAAMWVucA5MA6IFhpG2lZqCke9vn15";				
				...
				if ($resp->is_valid) {
					...
					if ($_POST['sel']==1 && isset($_POST['paga'])) {
						...
						$paypal='standby';
						$copies =pg_escape_string($_POST['ccantidad']);
						$cant= (int) pg_escape_string($_POST['ccantidad'])* 700;
						//$cant=1;
						...
						echo '
						 ...
						 <table width="116" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
							  <td>Licenses:</td>
							  <td align="right">'.pg_escape_string($_POST['ccantidad']).'</td>
							</tr>
						  </table>
						  <p><br></p>	
						...
						<form name="_xclick" action="https://www.paypal.com/cgi-bin/webscr" method="POST">
								...
								<input type="hidden" name="business" value="grivera@rdataa.com">
								<input type="hidden" name="currency_code" value="USD">
								<input type="hidden" id="orderName" name="item_name" value="AAnalyzer">
								<input type="hidden" id="orderTotal" name="amount" value="'.$cant.'">
								<input type="hidden" id="orderTotal" name="custom" value="'.$IdPay.'">
							    <input type="hidden" id="orderName" name="item_name" value="'.pg_escape_string($_POST["ccantidad"]).' License(s) AAnalyzer.">
						
								<input type="hidden" name="return" value="http://www.rdataa.com/aanalyzer/scss.htm">
								<input type="hidden" name="cancel_return" value="http://www.rdataa.com/aanalyzer/cncl.htm">
								<input type="hidden" name="notify_url" value="http://www.rdataa.com/aanalyzer/PayPal/ipn.php">
					
					
						<input type="image" src="http://www.paypalobjects.com/en_US/i/btn/btn_paynow_LG.gif" border="0" name="submit" alt="Make payments with PayPal - its fast, free and secure!">
