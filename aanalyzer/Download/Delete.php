...
;
     ...
     // execute query
     $sql = "INSERT  into customer (firstname,lastname,address1,address2,city,state,zip,country,email,phone,creditcardtype,creditcard,creditcardexpiration,username,password,organization,userfullname) VALUES ( '$firstname' ,'$lastname','$address1','$address2','$city','$state','$zip','$country','$email','$phone','$creditcardtype','$creditcard','$creditcardexpiration','$username','$password','$organization','$userfullname')";
