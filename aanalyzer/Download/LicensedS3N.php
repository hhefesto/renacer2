...
if ($_POST['sel']==2 && isset($_POST['submit2']))  {
    $firstname = mysqli_real_escape_string($_POST['cfirstname']);
    ...
    $IdPay= date('Hidmy');
//    $paypal='WIRE';
    $sql = "INSERT  into paypal (customerid,firstname,lastname,address1,address2, zip, city,state,country,email, quantity, idpaypal) VALUES (NULL, '$firstname' ,'$lastname','$address1','$address2','$zip','$city','$state','$country','$email','$copies','$IdPay')";
    //echo "<br><br>". $sql;
    $fillform = false;
