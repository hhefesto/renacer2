...
// $fillform = true;
	...
	<p>&nbsp;</p>
<form name="form1" method="POST" action="LicensedS3g.php">

  <p>Email:  
    <input name="ccorreo" type="text" id="ccorreo" size="40">
</p>
  <p>
   Licenses: 
    <select name="ccantidad" id="ccantidad">
      <option value="5,1">5 licenses for ONE year</option>
      <option value="5,2">5 licenses for TWO years</option>
      <option value="5,3">5 licenses for THREE years</option>
      <option value="10,1">10 licenses for ONE year</option>
      <option value="10,2">10 licenses for TWO years</option>
      <option value="10,3">10 licenses for THREE years</option>
      <option value="20,1">20 licenses for ONE year</option>
      <option value="20,2">20 licenses for TWO years</option>
      <option value="20,3">20 licenses for THREE years</option>
    </select>
</p>
