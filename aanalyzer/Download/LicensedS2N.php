...
// $fillform = true;
	...
	echo '				<h2>Step 2. Fill the following form </h2>
						  <form action="LicensedS3N.php" method="POST" >
	...
	<p>&nbsp;</p>
<form name="form1" method="POST" action="LicensedS3N.php">

  <p>
   Licenses: 
    <select name="ccantidad" id="ccantidad">
      <option value="1,1,700">1 license for ONE year</option>
      <option value="1,2,1000">1 license for TWO years</option>
      <option value="1,3,1300">1 license for THREE years</option>
      <option value="2,1,1200">2 licenses for ONE year</option>
      <option value="2,2,1700">2 licenses for TWO years</option>
      <option value="2,3,2300">2 licenses for THREE years</option>
      <option value="3,1,1500">3 licenses for ONE year</option>
      <option value="3,2,2200">3 licenses for TWO years</option>
      <option value="3,3,3000">3 licenses for THREE years</option>

      <option value="5,1,2000">5 licenses for ONE year</option>
      <option value="5,2,3000">5 licenses for TWO years</option>
      <option value="5,3,4000">5 licenses for THREE years</option>
      <option value="10,1,3000">10 licenses for ONE year</option>
      <option value="10,2,4500">10 licenses for TWO years</option>
      <option value="10,3,6000">10 licenses for THREE years</option>
      <option value="20,1,4500">20 licenses for ONE year</option>
      <option value="20,2,7000">20 licenses for TWO years</option>
      <option value="20,3,9000">20 licenses for THREE years</option>
